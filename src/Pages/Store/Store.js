    ...
    <div className='storeWrapper'>
      ...
      <div className='storeContent mt-5'>
        <div className='container'>
          ...
          <div className='cardsScroller pb-5'>
            <div className='cardsScrollerHeader text-start'>
          ...
          <div className='MainProducts'>
            <div className='cardsScrollerHeader alert-dark text-start'>
              <h3 className='cardsScrollerTitle m-0'>
                <span className='colorTitle'>Personalization.</span>  Make it one of a kind.
              </h3>
            </div>
            <div className='MainProductsContent'>
              <div className='mainProductSlider w-100 d-flex overflow-x-scroll'>
                <MainProducts />
              </div>
            </div>
          </div>
